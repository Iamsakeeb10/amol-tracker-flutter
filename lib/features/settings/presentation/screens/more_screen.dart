                ...
                children: [
                  if (isFullAdmin) ...[
                    ...
                    NavRow(
                      ...
                      onTap: () {
                        AnalyticsService.instance.logFeatureTapped('admin_users', screen: 'more');
                    ...
                    NavRow(
                      ...
                      onTap: () {
                        AnalyticsService.instance.logFeatureTapped('admin_home_banners', screen: 'more');
                        context.push(AppRoutes.adminHomeBanners);
                      },
                    ),
                    const Divider(),
                    NavRow(
                  ...
                  if (isFullAdmin) ...[
                    ...
                    NavRow(
                      ...
                      title: l10n.adminQuestionReportsTitle,
                      onTap: () {
                        AnalyticsService.instance.logFeatureTapped('admin_question_reports', screen: 'more');
                        context.push(AppRoutes.adminQuestionReports);
                      },
                    ),
                  ],
                ],
