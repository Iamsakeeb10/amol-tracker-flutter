...
abstract class AppLocalizations {
  ...
  /// No description provided for @adminShowReminderCard.
  ///
  /// In en, this message translates to:
  /// **'Show Home Reminder Card'**
  String get adminShowReminderCard;

  /// No description provided for @adminShowBattleBanner.
  ///
  /// In en, this message translates to:
  /// **'Show Battle Teaser Banner'**
  String get adminShowBattleBanner;

  /// No description provided for @adminBannersSaved.
  ///
  /// In en, this message translates to:
  /// **'Banners config saved.'**
  String get adminBannersSaved;
