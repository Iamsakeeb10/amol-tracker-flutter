...
class AdminLessonTile extends StatelessWidget {
  const AdminLessonTile({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Dismissible(
        key: ValueKey<String>('dismiss-${lesson.id}'),
        ...
        child: CardContainer(
          ...
          child: Row(
            children: [
              ...
              SizedBox(width: 8.w),
              AdminIconBox(icon: iconForResourceType(lesson.resourceType)),
              SizedBox(width: 12.w),
              Expanded(
                child: Column(
